...
void testIterator(SortedBag& sb, TRelation rel) {
    SortedBagIterator it = sb.iterator();
    TComp e1;
    TComp e2;
    if (it.valid()) {
...
void testIterator(TRelation rel) {
