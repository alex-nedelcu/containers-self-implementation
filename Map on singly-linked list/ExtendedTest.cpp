...
void testCreate() {
    ...
    cout << "Create tests successfully finished" << endl;
}
...
void testAdd() {
    ...
    testIteratorSteps(m);
    assert(m.size() == 20000);
    cout << "Add tests successfully finished" << endl;
}
...
void testRemove() {
    ...
    assert(m.size() == 0);
    cout << "Remove tests successfully finished" << endl;
}
...
void testIterator() {
    ...
    assert(count == 50);
    cout << "Iterator tests successfully finished" << endl;
}
...
void testQuantity() {
    ...
    assert(m.size() == 0);
    cout << "Quantity tests successfully finished" << endl;
}
